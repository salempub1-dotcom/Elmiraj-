    ...
    <div className="min-h-screen bg-gray-50 font-sans" dir="rtl">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate('/')}
              className="relative bg-#102A52hover:bg-#0B1833text-white p-3 rounded-xl transition-all"
            >
              🛒
              {cartCount > 0 && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg aspect-square cursor-pointer group" onClick={() => setLightbox(true)}>
              ...
              <span className="absolute top-4 left-4 bg-#102A52text-white text-sm px-3 py-1.5 rounded-full font-bold">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-blue-100 text-#102A52text-xs px-3 py-1 rounded-full font-bold">
                  {catEmoji} {product.category}
                </span>
                {product.sales > 80 && (
            ...
            {safeArr(product.benefits).length > 0 && (
              <div className="bg-white rounded-2xl border-2 border-gray-100 p-5">
                <h3 className="text-lg font-bold text-#0B1833mb-3">✅ الفوائد التعليمية</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                {quantity > 1 && (
                  <span className="text-#102A52font-bold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="bg-#102A52hover:bg-#0B1833text-white py-4 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  🛒 أضف للسلة
                </button>
              </div>
              ...
              <button
                ...
                className="w-full bg-#183C6B hover:bg-#183C6B text-white py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2"
              >
                📱 طلب سريع عبر واتساب
              </button>
            </div>
      ...
      <section className="bg-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-#0B1833mb-8">🎯 لماذا تختار المعراج؟</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-blue-50 rounded-2xl p-6 text-center hover:shadow-md transition-all">
                ...
                <h3 className="text-lg font-bold text-#0B1833mb-2">{feature.title}</h3>
      ...
      {related.length > 0 && (
        <section className="py-12 px-4 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold text-center text-#0B1833mb-8">
              ...
              {related.map(rp => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-#102A52font-bold">{rp.price.toLocaleString()} دج</p>
                  </div>
                </button>
              ))}
            </div>
      ...
      {/* ── CTA SECTION ──────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-#071226 via-#0B1833to-#102A52text-white py-12 px-4">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-gray-50 rounded-xl p-4 flex gap-3 items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-#102A52font-bold">{(product.price * quantity).toLocaleString()} دج × {quantity}</p>
                </div>
              </div>
              <div>
              ...
              <button
                ...
                className="w-full bg-#183C6B hover:bg-#183C6B text-white py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2"
              >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-100 p-3 flex gap-2 md:hidden z-40 shadow-2xl">
        ...
        <button
          onClick={handleAddToCart}
          className="flex-1 bg-#102A52hover:bg-#0B1833text-white py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-1"
        >
          🛒 أضف للسلة
        </button>
      </div>
