      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center" dir="rtl">
        <div className="text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-blue-700 font-bold text-lg">جاري تحميل الصفحة...</span>
          </div>
        </div>
      </div>
    );
          ...
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-xl font-bold transition-all text-center"
              >
                📱 تواصل معنا
              </a>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans" dir="rtl">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate('/')}
              className="bg-blue-700 hover:bg-blue-800 text-white p-3 rounded-xl transition-all"
            >
              🛒
            </button>
          </div>
      ...
      <section className="relative">
          ...
          <div className="relative h-[50vh] md:h-[60vh] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
              <div className="max-w-4xl mx-auto">
                {product?.category && (
                  <span className="inline-block bg-blue-600 text-white text-sm px-4 py-1.5 rounded-full font-bold mb-4">
        ...
        {!displayImage && (
          <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-20 px-4">
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-6 md:p-8 space-y-4">
                  ...
                  <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-left">
                        <p className={`font-bold text-sm ${product.stock > 10 ? 'text-blue-600' : product.stock > 0 ? 'text-amber-600' : 'text-red-600'}`}>
                  ...
                  {product.benefits && product.benefits.length > 0 && (
                    <div>
                      <h3 className="font-bold text-blue-800 mb-2">✅ الفوائد التعليمية</h3>
                      <ul className="space-y-2">
                        {product.benefits.map((b, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <span className="bg-blue-100 text-blue-600 w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold mt-0.5">
                              {i + 1}
                            </span>
          ...
          <div className="bg-gradient-to-r from-blue-700 to-blue-800 rounded-2xl p-8 text-center text-white shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl font-bold transition-all text-center"
              >
                📱 تواصل عبر واتساب
              </a>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-100 p-3 flex gap-2 md:hidden z-40 shadow-2xl">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-xl font-bold transition-all flex items-center justify-center"
        >
          📱
        </a>
      </div>
