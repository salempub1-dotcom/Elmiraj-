...
export async function handleAiAssistant(res, supabase, body) {
  ...
  try {
    // openrouter/free can route to different free models. Some reasoning-heavy
    // models may spend a small output budget without returning visible content,
    // so retry automatically with a larger budget before surfacing an error.
